 ...
 *         id:
 *           type: integer
 *           description: O ID do dado acadêmico.
 *         name:
 *           type: string
 *           description: O nome do curso ou programa de estudo.
 *         semester:
 *           type: integer
 *           description: O semestre ou período atual do curso.
 *         startDate:
 *           type: string
 *           format: date
 ...
 *         isCurrentlyStudying:
 *           type: boolean
 *           description: Indica se o aluno está atualmente estudando.
 *         institutionName:
 *           type: string
 *           description: O nome da instituição de ensino.
 *         degree:
 *           type: string
 *           description: O grau de escolaridade obtido.
 *         city:
 *           type: string
 *           description: A cidade da instituição de ensino.
 *         curriculumId:
 *           type: integer
 *           description: O ID do currículo associado.
 *       required:
 *         - name
 *         - semester
 *         - startDate
 ...
 *   get:
 *     tags: [Academic Data]
 *     summary: Retorna todos os dados acadêmicos
 *     responses:
 *       200:
 *         description: Lista de dados acadêmicos.
 *         content:
 *           application/json:
 *             schema:
 *               type: array
